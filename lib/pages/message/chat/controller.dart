...
import 'package:chatter/common/widgets/widgets.dart';
...
class ChatController extends GetxController{
  ...
  void onReady(){
    ...
    final messages = db.collection("message").doc(doc_id).collection("msglist")
        .withConverter(
    ...
    listener = messages.snapshots().listen((event) {
      ...
      if(myScrollController.hasClients){
        myScrollController.animateTo(
            //points to the very top your list, lowest index is 0
